...
const StatCard = ({ icon, value, label, colorClass }: StatCardProps): React.ReactNode => {
  return (
   <div className="bg-amber-50 pl-3 backdrop-blur-sm p-4 sm:p-5 rounded-xl shadow-lg flex items-center space-x-4 sm:space-x-5 border border-amber-100 transition-all hover:border-amber-200 hover:scale-[1.02] duration-300">
